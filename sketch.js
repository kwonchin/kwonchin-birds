...
let slingshotImg;  // Image for the slingshot

function preload() {
    titleScreen = loadImage("kwonchin_birds2.png");
    imgSkull = loadImage("skull_pillar.png");
    pumpkinImg = loadImage("banana.png");
    imgBoxSkull = loadImage("stone_chest.png");
    imgStone1 = loadImage("stone_platform2.png");
    imgBone1 = loadImage("stone_pillar.png");
    imgPlank1 = loadImage("plank.png");
    rectangleStone1 = loadImage("stone_tile2.png");
    rectangleStone2 = loadImage("rect_stone.png");
    monsterImg = loadImage("monster.png");
    slingshot1 = loadImage("slingshot.png");
}
...
function setup() {
  ...
  torch1 = new Torch(232, 540);
  torch2 = new Torch(1417, 455);
  torch3 = new Torch(1337, 255);

  explosionManager = new ExplosionManager();

  // Init objects

  slingshotImg = new StaticObject(150, 620, 60, 60, slingshot1);

  boxes.push(new GameObject(600, 650, 30, 100, imgBone1, 1.05));
  boxes.push(new GameObject(600, 550, 30, 100, imgBone1, 1.05));
  boxes.push(new GameObject(650, 600, 70, 70, monsterImg, 1.1, true, true));
  boxes.push(new GameObject(700, 650, 30, 100, imgBone1, 1.05));
  boxes.push(new GameObject(700, 550, 30, 100, imgBone1, 1.05));
  boxes.push(new GameObject(650, 480, 90, 90, rectangleStone1, 1.05));
  boxes.push(new GameObject(650, 450, 70, 70, rectangleStone2, 1.05));
  ...
  boxes.push(new GameObject(1135, 580, 70, 70, rectangleStone2, 1.05));
  boxes.push(new GameObject(1135, 510, 50, 50, monsterImg, 1.1, true, true));

  boxes.push(new GameObject(450, 650, 150, 12, imgPlank1, 1.05));
  boxes.push(new GameObject(450, 620, 70, 70, rectangleStone2, 1.05));
  ...
  boxes.push(new GameObject(850, 480, 150, 12, imgPlank1, 1.05));
  ...
  boxes.push(new GameObject(850, 220, 150, 12, imgPlank1, 1.05));
  boxes.push(new GameObject(850, 190, 70, 70, rectangleStone2, 1.05));
  boxes.push(new GameObject(850, 125, 50, 50, monsterImg, 1.1, true, true));
}
...
class Particle {
  constructor(x, y) {
    ...
    this.lifespan = 255;
    this.size = random(5, 10); // tamaño variable
  }
...
class PortalParticle {
  ...
  display() {
    noStroke();
    let r = random(200, 255); // Strong red component for yellow
    let g = random(200, 255); // Strong green component for yellow
    let b = 0; // No blue component for yellow
